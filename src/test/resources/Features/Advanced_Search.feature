...
Feature: Advanced Search Tests
  ...
  Scenario: User searches for a movie using number of votes
    ...
    When User enters maximum number of votes "155"
    When User scrolls down to the search button
    And clicks on the search button
  ...
  Scenario: User searches for a movie by genre
    ...
    #enter genre name in small letters. Replace hyphen with underscore to make genre dynamically work
    And User searches for their genre "animation"
    When User scrolls down to the search button
    And clicks on the search button
    #At this step enter the correct genre name
    Then User should be able to see all the "Animation" movies
  ...
  Scenario: User searches for a movie by country
    ...
    And User selects the country "Pakistan"
    When User scrolls down to the search button
    And clicks on the search button
    Then User should be able to see all the movies of the country "Pakistan"
