...
public class WatchList_Page {
    ...
    //public static String checkbox_to_remove_watchlist_movie_css = "label[for='2350769979']";
    ...
    //public static String checkbox_to_remove_watchlist_movie_id = "totalCheck";
    ...
    //public static WebElement get_checkbox_to_remove_watchlist_movie_css(){return driver.findElement(By.cssSelector(checkbox_to_remove_watchlist_movie_css));}
    ...
    //public static WebElement get_checkbox_to_remove_watchlist_id(){return driver.findElement(By.id(checkbox_to_remove_watchlist_movie_id));}
